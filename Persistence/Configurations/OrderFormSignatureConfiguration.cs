...
{
    public class OrderFormSignatureConfiguration : IEntityTypeConfiguration<OrderFormSignature>
    {
        public void Configure(EntityTypeBuilder<OrderFormSignature> builder)
        {
